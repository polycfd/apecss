...
Bubble = np.genfromtxt("Gilmore_R1.000e-06_fa1.000e+06_pa1.000e+06.txt", delimiter=" ")
...
ax3.plot(Bubble[:, 1]*1e6, Bubble[:, 5], linestyle='solid', linewidth=1.0,color='steelblue')
...
fig1.savefig('ultrasound_zener.pdf', bbox_inches='tight',pad_inches=0.035)
