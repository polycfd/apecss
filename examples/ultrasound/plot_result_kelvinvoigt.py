...
Bubble = np.genfromtxt("KellerMiksis_R1.000e-06_fa1.000e+06_pa3.000e+06.txt", delimiter=" ")
...
fig1.savefig('ultrasound_kelvinvoigt.pdf', bbox_inches='tight',pad_inches=0.035)
