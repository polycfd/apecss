...
ax4.set_xlim(xmin=0.995,xmax=1.02)
ax4.set_ylim(ymin=5e-1,ymax=5e3)
...
ax5.set_ylim(ymin=5e-1,ymax=5e3)
...
ax6.set_ylim(ymin=5e-1,ymax=5e3)
...
ax7.set_xlim(xmin=0.995,xmax=1.02)
