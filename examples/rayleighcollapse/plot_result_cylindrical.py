...
Bubble = np.genfromtxt("Gilmore_R2.110e-03.txt", delimiter=" ")
...
ax1.set_xlim(xmin=0,xmax=5e-4)
ax1.set_ylim(ymin=0,ymax=0.0025)
...
fig1.savefig('rayleighcollapse_cylindrical.pdf', bbox_inches='tight',pad_inches=0.035)
