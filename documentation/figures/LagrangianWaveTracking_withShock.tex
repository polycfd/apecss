...
\begin{tikzpicture}[scale=1]
        ...
        \draw[black,very thick,fill=Goldenrod3] (1.5,1.5) circle (0.08);
        ...
        \draw (2.63,0.45) node{\footnotesize {\color{red} $\boldsymbol{\times}$}};
        \draw (1.6,2) node{\scriptsize {\color{gray} Shock}};
        \draw (1.6,1.8) node{\scriptsize {\color{gray} formation}};
        ...
        \draw[black,very thick,fill=Goldenrod3] (2.3,0) circle (0.08);
        \draw[black,very thick,fill=Goldenrod3] (3.6,0) circle (0.08);
        \draw[black,very thick,fill=Goldenrod3] (5.3,0) circle (0.08);
        \draw (7.1,0) node{\footnotesize {\color{red} $\boldsymbol{\times}$}};
        \draw[densely dashed,thick,-{Stealth[scale=1.1]}] (0.72,1.3) -- (1.33,0.2);
        \draw[gray,densely dashed,thick,-{Stealth[scale=1.1]}] (1.6,1.3) -- (2.5,0.5);
        \draw[densely dashed,thick,-{Stealth[scale=1.1]}] (1.8,1.3) -- (2.26,0.2);
        \draw[densely dashed,thick,-{Stealth[scale=1.1]}] (2.87,1.3) -- (3.53,0.2);
        \draw[densely dashed,thick,-{Stealth[scale=1.1]}] (4.57,1.3) -- (5.23,0.2);
        \draw[densely dashed,thick,-{Stealth[scale=1.1]}] (6.37,1.3) -- (7.03,0.2);
