...
Installing APECSS on Windows is a little more involved than the installation on Unix. The installation\footnote{We are grateful to Maxime Montois for these detailed installation instructions, and to Pierre Couloumbel for further improvements.} described below presents a minimalist installation of APECSS on Windows 11, using {\tt MinGW} and {\tt MSYS2}. 
